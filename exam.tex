...
% Instructions: layout your instructions here.  You can use \showmarks{<marks>} command to show marks without counting them towards the total.  The \totalmarks{} command gives a sum of all marks from \addmarks[<mark>] and \items[<mark>]commands.
...
\question{To create a question use the \texttt{\textbackslash question\{<question text>\}} command.  Questions are numbered with Arabic numerals.
...
% Marked question
\question{Question numbering continues regardless of the sections.  To specify marks for the entire question use the \texttt{\textbackslash addmarks\{<mark>\}} command at the end of the question paragraph.\addmarks{6}
...
\question{Each question starts on a new page.  To create a question with marks per sub-question use the \texttt{\textbackslash question\{<question text>\}} command and then specify marks per item of the \texttt{subquestions} environment using the \texttt{\textbackslash item{[}mark{]} <item text>} syntax.
...
\question{To include answers use the \texttt{\textbackslash answer\{<answer text>\} command} under a question or sub-question.  Answers are printed in red and they show up on the pdf only when \texttt{draft} option is passed to the \texttt{otagoexam} document class.
    ...
    \begin{subquestions}
        ...
        \answer{You can provide answer for each sub-question.
            \begin{itemize}
                \item To included mark break-down for answers, use the \texttt{\textbackslash showMarks\{<marks>\} command} \showmarks{1.5} 
    ...
    \answer{All answers are removed in the final (no draft option) \texttt{otagoexam} document class mode.}
